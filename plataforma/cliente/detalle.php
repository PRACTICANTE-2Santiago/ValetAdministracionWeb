    ...
    <script type="text/javascript">
        ...
        function saveToken(token) {
            ...
            jQuery.ajax({
                ...
                type: "post",
                url: "http://19.168.1.64/valet_archivos/token.php",
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 main">
                                        <?php
                                            ...
                                            $auto= traeAuto($_GET['id'] ,$_GET['id_comercios'], -1);
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    ...
                                                    <div class="col-xs-12">
                                                        ...
                                                        <br />
                                                        <h4 style="color:#000000; ;text-align:JUSTIFY">8.- En caso de algún percance o golpe con el vehículo señalado en este boleto, la reparación de tal será en talleres de la empresa en un tiempo de 10 a 15 días hábiles a partir del siniestro, si el usuario procediera de manera indiferente sin causa justificada será baja costo y riesgo. El usuario del servicio asume por cuenta propia los gastos que se generen con motivo de traslados y demás accesorios durante el tiempo que permanezca el vehículo en reparación.</h4>
                                                        <br />
                                                        ...
                                                        <div class="col-xs-6">
                                                            ...
                                                            <button type="button" class="btn btn-danger " title="Declinar" <?php echo irA('controlador/ctl_detalle.php?m=3&id_val=' . $_GET['id_val'] . '&id=' . $_GET['id']  . '&id_comercios='.$_GET['id_comercios'].'&condi=1', 2); ?>> <span class="glyphicon glyphicon-remove"></span> Declinar</button>
                                                        </div>
                                                        <div class="col-xs-6">
                                                            <button type="button" class="btn btn-success " title="Aceptar" <?php echo irA('controlador/ctl_detalle.php?m=3&id_val=' . $_GET['id_val'] . '&id=' . $_GET['id'] . '&id_comercios='.$_GET['id_comercios'].'&condi=2', 2); ?>> <span class="glyphicon glyphicon-ok"></span> Aceptar</button>
                                                        </div>
                                        ...
                                        <?php } else if ($auto['condiciones'] == 2) { 
                                        ...
                                        if ($auto['estatus'] <= 4 and date('Y-m-d H:i:s') < $fecha_max and $auto['comentarios_cliente'] == '') { ?>
                                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                                        ...
                                                        <?php if ($auto['estatus'] == 2) { ?>
                                                            <button type="button" class="btn btn-success pull-right" title="Pedir Auto" <?php echo irAMsg('controlador/ctl_detalle.php?m=1&id_val=' . $_GET['id_val'] . '&id=' . $_GET['id'].'&id_comercios='.$_GET['id_comercios'], 'Pedir el auto?', 2); ?>> <span class="glyphicon glyphicon-ok"></span> Solicitar Auto ?</button>
                                                        <?php } ?>
                                                        ...
                                                        <?php if ($auto['estatus'] > 3) { ?>
                                                            ...
                                                            <?php if ($auto['comentarios_cliente'] == '' and $auto['estatus'] == 4) { ?>
                                                                ...
                                                                <form role="form" method="post" action="controlador/ctl_detalle.php?m=2&id_val=<?php echo $_GET['id_val'] . '&id=' . $_GET['id'].'&id_comercios='.$_GET['id_comercios']; ?>" name="aviso">
                                                                    <div class="form-group">
