        ...
        <div class="row">
          ...
          ?>
                <h2 class="sub-header">
                    ...
                    <button type="button" name="nvousu" class="btn btn-primary" title="Nuevo Equipo" <?php echo irA('usuario.php', 2); ?>>
                ...
                <h4 class="text-right">
                    <button type="button" class="btn btn-success" onclick="location.href='usuarios.php?esta=1';"> Activos( <?php echo traeEstatusUsua(1); ?> ) </button>

                    <button type="button" class="btn btn-danger" onclick="location.href='usuarios.php?esta=0';"> Inactivos( <?php echo traeEstatusUsua(0); ?> ) </button>
                </h4>
                <br>
                <br>
                    ...
                    <table id="filtro" class="table table-striped table-bordered dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $usua['nombre'].' '.$usua['paterno'].' '.$usua['materno'] ?></td>
