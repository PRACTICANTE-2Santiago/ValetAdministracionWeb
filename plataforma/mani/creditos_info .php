                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        ...
                        <div class="form-group">
                            <div class="col-sm-7 col-md-5 col-lg-3 text-right">
                                <label for="titulo">Direcci&oacute;n: </label>
                            </div>
                            <?php echo 'Calle: '.$usu['calle'].' No. Ext: '.$usu['num_ext'].($usu['num_int']=='0' ? '' : ' No. Int: '.$usu['num_int'] ).'  Colonia: '.$usu['colonia'].' <br> Municipio: '.$usu['municipio'].'  Estado: '.$usu['estado'].' País: '.$usu['pais'].' C.P: '.$usu['codigo_postal']; ?>
                        </div>
