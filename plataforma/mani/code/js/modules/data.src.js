...
(function(factory) {
    ...
    (function(Highcharts) {
         ...
         * on GS](http://developers.google.com/gdata/samples/spreadsheet_sample).
         *
         * @type {String}
         ...
         * your sheet can be read from `http://spreadsheets.google.com/feeds/worksheets/{key}/public/basic`.
         *
         * @type {String}
         * @sample {highcharts} highcharts/data/google-spreadsheet/ Load a Google Spreadsheet
         * @since 4.0
        ...
        Highcharts.extend(Data.prototype, {
            ...
            complete: function() {
                ...
                if (options.complete || options.afterComplete) {
                    ...
                    for (
                        seriesIndex = 0; seriesIndex < this.valueCount.seriesBuilders.length; seriesIndex++
                    ) {
                    ...
                    if (type === 'category') {
                        for (
                            seriesIndex = 0; seriesIndex < allSeriesBuilders.length; seriesIndex++
                        ) {
