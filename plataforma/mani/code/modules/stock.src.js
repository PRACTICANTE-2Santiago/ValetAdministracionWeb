...
(function(factory) {
    ...
    (function(Highcharts) {
         ...
         * [time](http://api.highcharts.com/highcharts/time) options set.
         *
        ...
        Highcharts.Time.prototype = {
             ...
             * [JDate](http://githubcom/tahajahangir/jdate) can be hooked in to
             * handle Jalali dates.
             * 
             * @type {Object}
             * @since 4.0.4
             ...
             * [getTimezoneOffset](http://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/getTimezoneOffset)
    ...
    (function(H) {
         ...
         *         http://api.highcharts.com/highstock|options reference}.
         ...
         *         the callback. Defining a {@link http://api.highcharts.com/highstock/chart.events.load|
         ...
         * @memberOf Axis.prototype
         *
         * @see    {@link http://api.highcharts.com/highstock/series.plotOptions.compare|
