...
<body>
    ...
    <div class="container-fluid">
        ...
        ?>
                <?php
                $usu=  traeChoferes($_GET['id'],$_SESSION['idvalet'] ,1);

                        if(sizeof($usu) > 0){
			
		?>
                <h3 class="page-header">Datos >> <a href="choferes.php?esta=1">Choferes</a> </h3>


                <h2 class="sub-header"><?php echo 'Nombre: '.$usu['nombre'].' '.$usu['apellido_paterno'].' '.$usu['apellido_materno']; ?></h2>
