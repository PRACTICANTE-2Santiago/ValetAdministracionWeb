    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <h3 class="page-header"> Datos >> <a href="usuarios.php"> Administradores </a> </h3>
        ...
        ?>
                ...
                <h2 class="sub-header">Registrar Administrador</h2>
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <br>

                        <form role="form" name="nvoproducto" method="post" enctype="multipart/form-data" action="controlador/ctl_usuarios.php?m=1<?php echo '&idvalet='.$_SESSION['idvalet'].'&tipo='.$_SESSION['idtipo']; ?>">
                            <section id="section-1" class="content-current">
                                <h4 style="color:#418bca; font-weight:bold;text-align:center">DATOS PERSONALES</h4>
                                <br>
                                <div class="col-sm-4">
