...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <?php if(isset($_GET['edit']) && isset($_GET['id'])){
        								...
        								$admin = traeChoferes($_GET['id'] ,0, '', -1);
                ...
                <h3 class="page-header"> Datos >> <a href="choferes.php"> Choferes </a> </h3>

                <h2 class="sub-header">Modificar Chofer</h2>
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <br>
                        <form role="form" name="nvoproducto" method="post" enctype="multipart/form-data" action="controlador/ctl_choferes.php?m=2&id=<?php echo $admin['id']; ?>">
                            <section id="section-1" class="content-current">
                                ...
                                <div class="fo-top">
                                    <div class="form-group">
                                        <label for="focusedinput">INE</label>

                                        <input type="text" class="form-control" name="ine" id="ine" placeholder="INE" required="required" value="<?php echo $admin['ine'];?>">
                                ...
                                <div class="fo-top">
                                    <div class="form-group">
                                        <div class="col-sm-6 ctl">
                                            <label for="focusedinput">Licencia</label>
                                            <input type="text" class="form-control" name="licencia" id="licencia" placeholder="Licencia" required="required" value="<?php echo $admin['licencia'];?>">
                                        </div>
                                ...
                                <div class="fo-top">
                                    <div id='valCorreo'>
                                        <div class="form-group">
                                            ...
                                            <input type="mail" class="form-control" onchange="verificar_correo();" id="correo_electronico" name="correo_electronico" placeholder="Correo Electr&oacute;nico" value="<?php echo $admin['correo_electronico'];?>" required="required">
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="fo-top">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="contrasena" placeholder="Contrase&ntilde;a" required="required" minlength="6" value="<?php echo $admin['contrasenia'];?>">
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                                <br>
        ...
        ?>
                ...
                <h2 class="sub-header">Registrar Chofer</h2>
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <br>

                        <form role="form" name="nvoproducto" method="post" enctype="multipart/form-data" action="controlador/ctl_choferes.php?m=1<?php echo '&idvalet='.$_SESSION['idvalet']; ?>">
                            <section id="section-1" class="content-current">
                                <h4 style="color:#418bca; font-weight:bold;text-align:center">DATOS PERSONALES</h4>
                                <br>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <div class="fo-top">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="apellido_paterno" id="apellido_paterno" placeholder="Nombre" required="required">
                                ...
                                <div class="col-sm-4">
                                    <div class="fo-top">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="apellido_materno" id="apellido_materno" placeholder="Nombre" required="required">
                                ...
                                <div class="fo-top">
                                    <div class="form-group">
                                        <div class="col-sm-6 ctl">
                                            <label for="focusedinput">INE</label>
                                            <input type="text" class="form-control" name="ine" id="ine" placeholder="INE" required="required">
                                        ...
                                        <div class="col-sm-6 ctl">
                                            <label for="focusedinput">Licencia</label>
                                            <input type="text" class="form-control" name="licencia" id="licencia" placeholder="Licencia" required="required">
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
